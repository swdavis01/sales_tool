...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_form2.default, {
	  __self: undefined
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _postcode = __webpack_require__(170);

	var _postcode2 = _interopRequireDefault(_postcode);

	var _systemSize = __webpack_require__(172);

	var _systemSize2 = _interopRequireDefault(_systemSize);

	var _gridRate = __webpack_require__(173);

	var _gridRate2 = _interopRequireDefault(_gridRate);

	var _digitalSolarRate = __webpack_require__(174);

	var _digitalSolarRate2 = _interopRequireDefault(_digitalSolarRate);

	var _consumption = __webpack_require__(175);

	var _consumption2 = _interopRequireDefault(_consumption);

	var _solarUsed = __webpack_require__(176);

	var _solarUsed2 = _interopRequireDefault(_solarUsed);

	var _sunshineHours = __webpack_require__(177);

	var _sunshineHours2 = _interopRequireDefault(_sunshineHours);

	var _systemCost = __webpack_require__(178);

	var _systemCost2 = _interopRequireDefault(_systemCost);

	var _errors = __webpack_require__(179);

	var _errors2 = _interopRequireDefault(_errors);

	var _Validate = __webpack_require__(180);

	var _Validate2 = _interopRequireDefault(_Validate);

	var _summary = __webpack_require__(181);
	...
	var Form = function (_Base) {
	    ...
	    _createClass(Form, [{
	        ...
	        value: function handleChange(e) {
	            ...
	            this.setState(_defineProperty({}, id, value), function () {
	        ...
	        value: function validate() {
	            ...
	            if (!_Validate2.default.Postcode(this.state.postcode)) {
	                res[res.length] = _Validate2.default.PostcodeError();
	            }

	            if (!_Validate2.default.GridRate(this.state.gridRate)) {
	                res[res.length] = 'Grid ' + _Validate2.default.GridRateError();
	            }

	            if (!_Validate2.default.GridRate(this.state.digitalSolarRate)) {
	                res[res.length] = 'Digital Solar ' + _Validate2.default.GridRateError();
	            }

	            if (!_Validate2.default.Consumption(this.state.consumption)) {
	                res[res.length] = _Validate2.default.ConsumptionError();
	            }

	            if (!_Validate2.default.SystemCost(this.state.systemCost)) {
	                res[res.length] = _Validate2.default.SystemCostError();
	            }

	            if (!_Validate2.default.SunshineHours(this.state)) {
	                res[res.length] = _Validate2.default.SunshineHoursError();
	            }
	        ...
	        key: "getAsUriParameters",
	        value: function getAsUriParameters(params) {
	            var url = '';
	        ...
	        value: function getSummaryData() {
	            ...
	            if (this.state.errors.length > 0) {
	                _reactDom2.default.render(_react2.default.createElement(_errors2.default, { id: 'errors', value: this.state.errors, __self: this
	            ...
	            $.ajax({
	                ...
	                success: function (result) {
	                    _reactDom2.default.render(_react2.default.createElement(_summary2.default, _extends({}, result.data, {
	                        __self: this
	                    })), document.getElementById('results'));
	                }.bind(this),
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "div",
	                    { className: 'bgc1 clearfix', __self: this
	                    },
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                "td",
	                                { className: 'firstCol', __self: this
	                                },
	                                _react2.default.createElement(
	                                    "div",
	                                    { className: 'clearFix', __self: this
	                                    },
	                                    _react2.default.createElement(_postcode2.default, { id: 'postcode', value: this.state.postcode, maxLength: '4', onChange: this.handleChange, __self: this
	                                    }),
	                                    _react2.default.createElement(_systemSize2.default, { id: 'systemSize', value: this.state.systemSize, onChange: this.handleChange, __self: this
	                                    })
	                                ),
	                                _react2.default.createElement(
	                                    "div",
	                                    ...
	                                    _react2.default.createElement(_gridRate2.default, { id: 'gridRate', value: this.state.gridRate, maxLength: '5', onChange: this.handleChange, __self: this
	                                    }),
	                                    _react2.default.createElement(_digitalSolarRate2.default, { id: 'digitalSolarRate', value: this.state.digitalSolarRate, maxLength: '5', onChange: this.handleChange, __self: this
	                                    })
	                                ),
	                                _react2.default.createElement(
	                                    "div",
	                                    ...
	                                    _react2.default.createElement(_systemCost2.default, { id: 'systemCost', value: this.state.systemCost, maxLength: '6', onChange: this.handleChange, __self: this
	                                    }),
	                                    _react2.default.createElement(_consumption2.default, { id: 'consumption', value: this.state.consumption, maxLength: '6', onChange: this.handleChange, __self: this
	                                    })
	                                ),
	                                _react2.default.createElement(
	                                    "div",
	                                    ...
	                                    _react2.default.createElement(_sunshineHours2.default, { id: 'sunshineHours', value: this.state, onChange: this.handleChange, __self: this
	                                    })
	                                )
	                            ),
	                            _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                "td",
	                                { className: 'lastCol', __self: this
	                                },
	                                _react2.default.createElement("div", { id: "results", __self: this
	                                })
	                            )
	                        )
	                    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Postcode = function (_Base) {
	    _inherits(Postcode, _Base);

	    function Postcode(props) {
	        _classCallCheck(this, Postcode);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Postcode).call(this, props));
	    }
	    ...
	    _createClass(Postcode, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                { className: 'glyph fs1', __self: this
	                },
	                _react2.default.createElement(_label2.default, { icon: 'icon-my_location', label: 'Postcode', __self: this
	                }),
	                _react2.default.createElement(
	                    "fieldset",
	                    { className: 'fs0 size1of1 clearfix hidden-false', __self: this
	                    },
	                    _react2.default.createElement("input", { type: "text", className: 'unit size1of1', placeholder: "postcode", id: this.props.id, value: this.props.value, maxLength: this.props.maxLength, onChange: this.props.onChange, __self: this
	                    })
	                )
	            );
	        }
	...
	var Label = function (_Base) {
	    ...
	    _createClass(Label, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                { className: 'clearfix bshadow0 pbs', __self: this
	                },
	                _react2.default.createElement("span", { className: this.props.icon, __self: this
	                }),
	                _react2.default.createElement(
	                    "span",
	                    { className: 'mls', __self: this
	                    },
	                    this.props.label
	                )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SystemSize = function (_Base) {
	    _inherits(SystemSize, _Base);

	    function SystemSize(props) {
	        _classCallCheck(this, SystemSize);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(SystemSize).call(this, props));
	    }

	    _createClass(SystemSize, [{
	        key: "handleChange",
	        value: function handleChange(e) {}
	    }, {
	        key: "render",
	        value: function render() {
	            ...
	            var createItem = function createItem(item, key) {
	                ...
	                return _react2.default.createElement(
	                    "option",
	                    { key: key, value: item.value, __self: this
	                    },
	                    item.name
	                );
	            };
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_label2.default, { icon: 'icon-wb_sunny', label: 'System Size', __self: this
	                }),
	                _react2.default.createElement(
	                    "fieldset",
	                    { className: 'fs0 size1of1 clearfix hidden-false', __self: this
	                    ...
	                    _react2.default.createElement(
	                        "select",
	                        { className: 'unit size1of1', id: this.props.id, value: this.props.value, onChange: this.props.onChange, __self: this
	                        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GridRate = function (_Base) {
	    _inherits(GridRate, _Base);

	    function GridRate(props) {
	        _classCallCheck(this, GridRate);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(GridRate).call(this, props));
	    }

	    _createClass(GridRate, [{
	        key: "handleChange",
	        value: function handleChange(event) {
	            this.setState({ value: event.target.value });
	        }
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_label2.default, { icon: 'icon-sentiment_dissatisfied', label: 'Grid Rate', __self: this
	                }),
	                _react2.default.createElement(
	                    "fieldset",
	                    { className: 'fs0 size1of1 clearfix hidden-false', __self: this
	                    },
	                    _react2.default.createElement("input", { className: 'unit size1of1', type: "text", placeholder: "grid rate", id: this.props.id, value: this.props.value, maxLength: this.props.maxLength, onChange: this.props.onChange, __self: this
	                    })
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DigitalSolarRate = function (_Base) {
	    _inherits(DigitalSolarRate, _Base);

	    function DigitalSolarRate(props) {
	        _classCallCheck(this, DigitalSolarRate);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(DigitalSolarRate).call(this, props));
	    }

	    _createClass(DigitalSolarRate, [{
	        key: "handleChange",
	        value: function handleChange(event) {
	            this.setState({ value: event.target.value });
	        }
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_label2.default, { icon: 'icon-sentiment_satisfied', label: 'Digital Solar Rate', __self: this
	                }),
	                _react2.default.createElement(
	                    "fieldset",
	                    { className: 'fs0 size1of1 clearfix hidden-false', __self: this
	                    },
	                    _react2.default.createElement("input", { className: 'unit size1of1', type: "text", placeholder: "digital solar rate", id: this.props.id, value: this.props.value, maxLength: this.props.maxLength, onChange: this.props.onChange, __self: this
	                    })
	                )
	            );
	        }
	    ...
	    return DigitalSolarRate;
	}(_base2.default);

	exports.default = DigitalSolarRate;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Consumption = function (_Base) {
	    _inherits(Consumption, _Base);

	    function Consumption(props) {
	        _classCallCheck(this, Consumption);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Consumption).call(this, props));
	    }
	    ...
	    _createClass(Consumption, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_label2.default, { icon: 'icon-grid_on', label: 'Yearly Grid KwH', __self: this
	                }),
	                _react2.default.createElement(
	                    "fieldset",
	                    { className: 'fs0 size1of1 clearfix hidden-false', __self: this
	                    },
	                    _react2.default.createElement("input", { className: 'unit size1of1', type: "text", placeholder: "consumption", id: this.props.id, value: this.props.value, maxLength: this.props.maxLength, onChange: this.props.onChange, __self: this
	                    })
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SolarUsed = function (_Base) {
	    _inherits(SolarUsed, _Base);

	    function SolarUsed(props) {
	        _classCallCheck(this, SolarUsed);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(SolarUsed).call(this, props));
	    }

	    _createClass(SolarUsed, [{
	        key: "handleChange",
	        value: function handleChange(e) {}
	    }, {
	        key: "render",
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "select",
	                        { id: this.props.id, value: this.props.value, onChange: this.props.onChange, __self: this
	                        },
	                        options.map(createItem)
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SunshineHoursCheckbox = function (_Base) {
	    _inherits(SunshineHoursCheckbox, _Base);

	    function SunshineHoursCheckbox() {
	        _classCallCheck(this, SunshineHoursCheckbox);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(SunshineHoursCheckbox).apply(this, arguments));
	    }

	    _createClass(SunshineHoursCheckbox, [{
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement("input", { type: "checkbox", id: this.props.id, checked: this.props.value, value: this.props.value, onChange: this.props.onChange, __self: this
	            });
	        }
	    }]);

	    return SunshineHoursCheckbox;
	}(_base2.default);

	var SunshineHours = function (_Base2) {
	    _inherits(SunshineHours, _Base2);

	    function SunshineHours(props) {
	        _classCallCheck(this, SunshineHours);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(SunshineHours).call(this, props));
	    }

	    _createClass(SunshineHours, [{
	        key: "handleChange",
	        value: function handleChange(e) {}
	    }, {
	        key: "getRow",
	        value: function getRow(type) {
	            ...
	            var checked1 = _react2.default.createElement(SunshineHoursCheckbox, { id: name1, value: this.props.value[name1], onChange: this.props.onChange, __self: this
	            });
	            var checked2 = _react2.default.createElement(SunshineHoursCheckbox, { id: name2, value: this.props.value[name2], onChange: this.props.onChange, __self: this
	            });
	            var checked3 = _react2.default.createElement(SunshineHoursCheckbox, { id: name3, value: this.props.value[name3], onChange: this.props.onChange, __self: this
	            });
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                "div",
	                { className: 'glyphlarge fs1', __self: this
	                },
	                _react2.default.createElement(_label2.default, { icon: 'icon-timer', label: 'Time Spent At Property', __self: this
	                }),
	                _react2.default.createElement(
	                    "fieldset",
	                    { className: 'fs0 size1of1large clearfix hidden-false', __self: this
	                    },
	                    _react2.default.createElement(
	                        "div",
	                        { className: 'paddingSmall', __self: this
	                        },
	                        _react2.default.createElement(
	                            "table",
	                            { className: 'size1of1large', __self: this
	                            },
	                            _react2.default.createElement(
	                                "thead",
	                                {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SystemCost = function (_Base) {
	    _inherits(SystemCost, _Base);

	    function SystemCost(props) {
	        _classCallCheck(this, SystemCost);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(SystemCost).call(this, props));
	    }
	    ...
	    _createClass(SystemCost, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_label2.default, { icon: 'icon-monetization_on', label: 'System Cost', __self: this
	                }),
	                _react2.default.createElement(
	                    "fieldset",
	                    { className: 'fs0 size1of1 clearfix hidden-false', __self: this
	                    },
	                    _react2.default.createElement("input", { className: 'unit size1of1', type: "text", placeholder: "system cost", id: this.props.id, value: this.props.value, maxLength: this.props.maxLength, onChange: this.props.onChange, __self: this
	                    })
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Errors = function (_Base) {
	    _inherits(Errors, _Base);

	    function Errors(props) {
	        _classCallCheck(this, Errors);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Errors).call(this, props));
	    }
	    ...
	    _createClass(Errors, [{
	        ...
	        value: function render() {
	            ...
	            var createItem = function createItem(item, key) {
	                return _react2.default.createElement(
	                    "div",
	                    { key: key, className: 'error', __self: this
	                    },
	                    "* ",
	                    item.name
	                );
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(_label2.default, { icon: 'icon-error', label: 'Errors', __self: this
	                    }),
	                    _react2.default.createElement(
	                        "fieldset",
	                        { className: 'fs0 size1of1large clearfix hidden-false', __self: this
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Validate = function (_Base) {
	    _inherits(Validate, _Base);

	    _createClass(Validate, null, [{
	        key: "Postcode",
	        value: function Postcode(value) {
	            if (value != undefined) {
	                var regex = /^\d+$/;
	        ...
	        key: "PostcodeError",
	        value: function PostcodeError() {
	            return 'Postcode must be a 4 digit number';
	        }
	    }, {
	        key: "GridRate",
	        value: function GridRate(value) {
	            if (value != undefined) {
	        ...
	        key: "Consumption",
	        value: function Consumption(value) {
	            if (value != undefined) {
	                var regex = /^\d+$/;
	                //console.log(regex.test(value));
	                if (!regex.test(value)) {
	        ...
	        key: "ConsumptionError",
	        value: function ConsumptionError() {
	            return 'Consumption should be a number up to 100000 KwH';
	        }
	    }, {
	        key: "SystemCost",
	        value: function SystemCost(value) {
	            if (value != undefined) {
	                var regex = /^\d+$/;
	                //console.log(regex.test(value));
	                if (!regex.test(value)) {
	        ...
	        key: "SystemCostError",
	        value: function SystemCostError() {
	            return 'System cost should be a number up to $100000';
	        }
	    }, {
	        key: "SunshineHours",
	        value: function SunshineHours(value) {
	        ...
	        key: "SunshineHoursError",
	        value: function SunshineHoursError() {
	    ...
	    function Validate(props) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Validate).call(this, props));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SummaryItem = function (_Base) {
	    _inherits(SummaryItem, _Base);

	    function SummaryItem() {
	        _classCallCheck(this, SummaryItem);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(SummaryItem).apply(this, arguments));
	    }
	    ...
	    _createClass(SummaryItem, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                { className: 'summaryItem', __self: this
	                },
	                _react2.default.createElement(
	                    "label",
	                    { className: this.props.type, __self: this
	                    },
	                    this.props.label,
	                    ": "
	                ),
	...
	var Summary = function (_Base2) {
	    _inherits(Summary, _Base2);

	    function Summary(props) {
	        _classCallCheck(this, Summary);

	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Summary).call(this, props));
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "div",
	                        { className: 'glyphmedium fs1', __self: this
	                        },
	                        _react2.default.createElement(_label2.default, { icon: 'icon-thumb_up', label: 'Return On Investment', __self: this
	                        }),
	                        _react2.default.createElement(
	                            "fieldset",
	                            { className: 'fs0 size1of1medium clearfix hidden-false', __self: this
	                            },
	                            _react2.default.createElement(SummaryItem, { label: 'Without Finance', value: _format2.default.IRR(this.props.ownerEndIRR), type: 'main', __self: this
	                            }),
	                            _react2.default.createElement(SummaryItem, { label: 'With Finance', value: _format2.default.IRR(this.props.ownerEndFinanceIRR), type: 'main', __self: this
	                            })
	                        )
	                    ),
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_label2.default, { icon: 'icon-monetization_on', label: 'Investment', __self: this
	                        }),
	                        _react2.default.createElement(
	                            "fieldset",
	                            { className: 'fs0 size1of1medium clearfix hidden-false', __self: this
	                            },
	                            _react2.default.createElement(SummaryItem, { label: 'Investment Payback Years', value: _format2.default.Int(this.props.ownerPaybackYear), type: 'main', __self: this
	                            }),
	                            _react2.default.createElement(SummaryItem, { label: 'Tenant Discount', value: _format2.default.Percentage(this.props.tenantDiscount), type: 'main', __self: this
	                            })
	                        )
	                    )
	                ),
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_label2.default, { icon: 'icon-money_off', label: 'Finance', __self: this
	                        }),
	                        _react2.default.createElement(
	                            "fieldset",
	                            { className: 'fs0 size1of1medium clearfix hidden-false', __self: this
	                            },
	                            _react2.default.createElement(SummaryItem, { label: 'Amount Financed', value: _format2.default.Cash(this.props.ownerLoanAmount), type: 'main', __self: this
	                            }),
	                            _react2.default.createElement(SummaryItem, { label: 'Finance Years', value: this.props.ownerFinanceYear, type: 'sub', __self: this
	                            }),
	                            _react2.default.createElement(SummaryItem, { label: 'Total Interest', value: _format2.default.Cash(this.props.ownerLoanInterestCost), type: 'sub', __self: this
	                            }),
	                            _react2.default.createElement(SummaryItem, { label: 'Monthly Repayments', value: _format2.default.Cash(this.props.ownerLoanMonthlyRepaymentCost), type: 'sub', __self: this
	                            })
	                        )
	                    ),
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_label2.default, { icon: 'icon-attach_money', label: 'Cash Flow', __self: this
	                        }),
	                        _react2.default.createElement(
	                            "fieldset",
	                            { className: 'fs0 size1of1medium clearfix hidden-false', __self: this
	                            },
	                            _react2.default.createElement(SummaryItem, { label: this.props.ownerMaxYieldYears + ' Years Cash Flow', value: _format2.default.Cash(this.props.ownerEndNetPAYU), type: 'main', __self: this
	                            }),
	                            _react2.default.createElement(SummaryItem, { label: 'Year 1 Cash Flow', value: _format2.default.Cash(this.props.ownerBeginRevenue), type: 'main', __self: this
	                            })
	                        )
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Format = function (_Base) {
	    ...
	    function Format(props) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Format).call(this, props));
	    }
...
/***/ function(module, exports) {
	...
	module.exports = {"orbUrl":"http://192.168.50.10:8082"};
